...
public class ReportColorRange  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            this.highBreakpoint == other.getHighBreakpoint() &&
            ((this.highColor==null && other.getHighColor()==null) || 
             (this.highColor!=null &&
              this.highColor.equals(other.getHighColor()))) &&
            this.lowBreakpoint == other.getLowBreakpoint() &&
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += new Double(getHighBreakpoint()).hashCode();
        if (getHighColor() != null) {
            _hashCode += getHighColor().hashCode();
        }
        _hashCode += new Double(getLowBreakpoint()).hashCode();
        if (getLowColor() != null) {
